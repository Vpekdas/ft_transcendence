...
export default async function LanguagePicker({ dom }) {
    dom.querySelectorAll(".btn.btn-secondary.dropdown-toggle").on("click", async () => {
    ...
    return /* HTML */ ` <div class="dropdown language-picker">
        <button
