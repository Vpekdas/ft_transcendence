    ...
    return /* HTML */ `
        <ul class="nav navbar">
            ...
            <li class="nav-item icon-link">
                <a class="icon-link nav-link custom-link ${activeTabClass("/")}" href="/">
                    <img src="/favicon.svg" class="img-fluid" width="21" height="21" />
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link custom-link ${activeTabClass("/profile")}" href="/profile/match-history">
            ...
            <li class="nav-item">
                <a class="nav-link custom-link ${activeTabClass("/logout")}" href="/logout">
